...
#include "../Server/Network/Handlers/requestAllGroupListHandler.h"
...
QT_INIT_METAOBJECT const QMetaObject RequestAllGroupListHandler::staticMetaObject = { {
    &MsgHandler::staticMetaObject,
    qt_meta_stringdata_RequestAllGroupListHandler.data,
    qt_meta_data_RequestAllGroupListHandler,
    qt_static_metacall,
    nullptr,
    nullptr
} };
