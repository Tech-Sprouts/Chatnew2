...
#include "../Client/Network/Handlers/group_add_request_result.h"
...
QT_MOC_LITERAL(3, 45, 9), // "GroupInfo"
QT_MOC_LITERAL(4, 55, 4), // "info"
QT_MOC_LITERAL(5, 60, 17), // "sigAddGroupFailed"
QT_MOC_LITERAL(6, 78, 7), // "MsgType"
QT_MOC_LITERAL(7, 86, 4), // "type"
QT_MOC_LITERAL(8, 91, 16) // "refreshGroupList"

    },
    "AddGroupResultHandler\0sigAddGroupSuccessful\0"
    "\0GroupInfo\0info\0sigAddGroupFailed\0"
    "MsgType\0type\0refreshGroupList"
};
...
void AddGroupResultHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigAddGroupSuccessful((*reinterpret_cast< GroupInfo(*)>(_a[1]))); break;
        ...
        {
            using _t = void (AddGroupResultHandler::*)(GroupInfo );
...
// SIGNAL 0
void AddGroupResultHandler::sigAddGroupSuccessful(GroupInfo _t1)
{
