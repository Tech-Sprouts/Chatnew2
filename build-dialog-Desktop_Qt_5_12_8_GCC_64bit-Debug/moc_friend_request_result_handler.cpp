...
#include "../Client/Network/Handlers/friend_request_result_handler.h"
...
QT_MOC_LITERAL(5, 60, 22) // "sigAddFriendSuccessful"

    },
    "FriendRequestResultHandler\0"
    "sigAddFriendFailed\0\0MsgType\0type\0"
    "sigAddFriendSuccessful"
};
...
void FriendRequestResultHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigAddFriendFailed((*reinterpret_cast< MsgType(*)>(_a[1]))); break;
        case 1: _t->sigAddFriendSuccessful(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (FriendRequestResultHandler::*)(MsgType );
...
// SIGNAL 0
void FriendRequestResultHandler::sigAddFriendFailed(MsgType _t1)
{
...
// SIGNAL 1
void FriendRequestResultHandler::sigAddFriendSuccessful()
{
